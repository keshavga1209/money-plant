...
function Working() {
  return (
    <div id="hiw">
      <h3 className="head1">What’s MoneyPlant</h3>
      <p className="body-intro">MoneyPlant is an online crowdfunding platform built on the Tezos Blockchain. It enables anyone to raise funds for healthcare, education, sports, disaster relief and other personal causes, with great ease and transparency.</p>
